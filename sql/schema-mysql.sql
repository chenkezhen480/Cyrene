-- ============================================================
-- Cyrene Agent - MySQL 总表（含 users 表）
-- Database: agent（需提前创建好）
-- 包含：审计追踪、会话、消息、用户偏好、用户
-- 执行前请先: CREATE DATABASE IF NOT EXISTS `agent` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- ============================================================
...
CREATE TABLE IF NOT EXISTS `user_preferences` (
    `id`                BIGINT          NOT NULL AUTO_INCREMENT                          COMMENT '自增主键',
    `user_id`           VARCHAR(128)    NOT NULL     DEFAULT ''                         COMMENT '用户ID',
    `category`          VARCHAR(64)     NOT NULL     DEFAULT ''                         COMMENT '偏好类别（如：coding_style/response_format）',
